...
if (argument == null || argument == "" || argument <= 13 || argument  > 13)
  {
    alert( "Der Nutzer " + person +" hat keine Eingabe eingegeben! ")
  }

else{
    alert("Info: Ihr Name lautet " + person +" und Ihnen geht es "+ argument+ " !")
  };
